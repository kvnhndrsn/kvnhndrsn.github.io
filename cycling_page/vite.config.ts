...
export default defineConfig({
  ...
  // 1. Sets the base URL path for asset loading within Eleventy
  ...
  build: {
    manifest: true,
    modulePreload: false,
    // 2. Directs output into Eleventy's _site output directory under /cycling
    outDir: '../_site/cycling',
    // 3. Prevents wiping Eleventy's generated static files when Vite runs
    emptyOutDir: false,
  },
});
